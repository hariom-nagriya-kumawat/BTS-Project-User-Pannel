...
export const cartAction = {
  ...
  ADD_CART_WITHOUT_LOGIN_REQUEST: "ADD CART WITHOUT LOGIN REQUESTED!",
  ...
  DELETE_CART_REQUEST: "DELETE CARTS REQUESTED!",
...
export const addCartWithOutLoginRequest = createAction(
  cartAction.ADD_CART_WITHOUT_LOGIN_REQUEST
);
...
export const deleteCartRequest = createAction(
  cartAction.DELETE_CART_REQUEST
);

export const deleteCartSuccess = createAction(
  cartAction.DELETE_CART_SUCCESS
);
export const deleteCartFailed = createAction(
  cartAction.DELETE_CART_FAILED
);
